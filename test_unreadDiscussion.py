...
class TestUnreadDiscussion():
  ...
  def test_unreadDiscussion(self):
    ...
    self.driver.find_element(By.LINK_TEXT, "Discussions").click()
    self.driver.find_element(By.NAME, "filter-dropdown").click()
    dropdown = self.driver.find_element(By.NAME, "filter-dropdown")
    dropdown.find_element(By.XPATH, "//option[. = 'Unread']").click()
