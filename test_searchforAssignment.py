...
class TestSearchforAssignment():
  ...
  def test_searchforAssignment(self):
    ...
    element = self.driver.find_element(By.LINK_TEXT, "Assignments")
    actions = ActionChains(self.driver)
    actions.move_to_element(element).perform()
    self.driver.find_element(By.LINK_TEXT, "Assignments").click()
    self.driver.find_element(By.ID, "search_term").click()
