...
class TestPeopleTA():
  ...
  def test_peopleTA(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".ic-DashboardCard__header_content").click()
    self.driver.find_element(By.LINK_TEXT, "People").click()
    self.driver.find_element(By.NAME, "enrollment_role_id").click()
    dropdown = self.driver.find_element(By.NAME, "enrollment_role_id")
    dropdown.find_element(By.XPATH, "//option[. = 'TA (0)']").click()
