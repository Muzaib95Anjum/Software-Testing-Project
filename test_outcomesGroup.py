...
class TestOutcomesGroup():
  ...
  def test_outcomesGroup(self):
    ...
    element = self.driver.find_element(By.LINK_TEXT, "Outcomes")
    actions = ActionChains(self.driver)
    actions.move_to_element(element).perform()
    self.driver.find_element(By.LINK_TEXT, "Outcomes").click()
    self.driver.find_element(By.CSS_SELECTOR, ".add_outcome_group > .ui-button-text").click()
